...
# Installs all dev-workflow skills via symlinks: github-cli-skill, gh-create-release, git-workflow, git-worktree, git-pr, local-workflow, docmd, scanning-for-secrets
#
